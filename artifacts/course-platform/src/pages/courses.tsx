                ...
                <Card className="h-full bg-card border-border hover:border-primary/50 transition-all duration-200 cursor-pointer group">
                  <div className="relative w-full aspect-video overflow-hidden rounded-t-lg">
                    ...
                    {(course as { tag?: string | null }).tag === "coming_soon" && (
                      <div className="absolute top-2 left-2 z-10 bg-slate-950/80 backdrop-blur-md border border-primary/60 text-white text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-md shadow-lg shadow-primary/30">
                        Coming Soon
                      </div>
                    )}
                  </div>
