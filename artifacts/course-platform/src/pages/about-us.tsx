    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-5 text-muted-foreground leading-relaxed mb-14">
          <p>
            Vipul Kumar Academy was founded with a single frustration: the gap between what business schools teach and what actually works online. The founders started their entrepreneurial journey with almost nothing — a laptop, a Wi-Fi connection, and a relentless drive to figure things out through trial and error.
          </p>
          <p>
          ...
          <p>
            So they built the school they wished they had. Vipul Kumar Academy was born from real campaigns, real failures, and real wins. Every module, every case study, and every strategy comes directly from active business operations — not theory.
          </p>
        </div>
