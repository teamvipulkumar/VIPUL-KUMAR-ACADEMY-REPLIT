...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* 3 Simple Steps */}
      <section className="relative py-20 px-6 overflow-hidden" style={{ background: "radial-gradient(ellipse 80% 55% at 50% 0%, rgba(30,58,138,0.3) 0%, transparent 70%), #060d1f" }}>
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle,rgba(255,255,255,0.035)_1px,transparent_1px)] bg-[size:32px_32px]" />
              ...
              <div key={num} className="flex flex-col items-center text-center">
                <div className="relative mb-6">
                  <div className="w-20 h-20 rounded-2xl flex items-center justify-center"
                    style={{ background: "linear-gradient(135deg,#0f1f45 0%,#162050 100%)", boxShadow: "0 0 0 1px rgba(99,139,255,0.18), 0 8px 32px rgba(30,58,138,0.45)" }}>
                    <Icon className="w-8 h-8 text-blue-400" strokeWidth={1.5} />
                  </div>
                  <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-blue-600 flex items-center justify-center shadow-lg shadow-blue-900/60">
