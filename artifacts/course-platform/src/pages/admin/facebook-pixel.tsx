        ...
        <Card className="bg-card border-amber-500/30">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base text-amber-300">Add Your Domain in Meta Business Manager</CardTitle>
            </div>
          </CardHeader>
          <CardContent className="space-y-3 text-xs text-muted-foreground">
            <p>
              For test events to show up, your website domain must be verified in Meta Business Manager. Without this, Meta blocks pixel data from unrecognised domains.
            </p>
            <div className="rounded-lg bg-amber-500/10 border border-amber-500/20 p-3 space-y-1.5 text-amber-200">
              <ol className="space-y-1 list-none">
                {[
                  ...
                  "Click Add and enter your website domain (e.g. yourdomain.com)",
                  "Verify ownership via the DNS TXT record shown",
                  "Once verified, pixel events will fire without restrictions",
                ].map((s, i) => (
