    ...
    <div className="bg-card border border-border rounded-2xl overflow-hidden hover:border-primary/40 transition-all group">
      <div className="relative aspect-video bg-gradient-to-br from-primary/20 via-primary/10 to-transparent flex items-center justify-center overflow-hidden">
        ...
        {e.course?.tag === "coming_soon" && (
          <div className="absolute top-3 left-3 z-10 flex items-center gap-1.5 bg-slate-950/80 backdrop-blur-md border border-primary/60 text-primary text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-md shadow-lg shadow-primary/30">
        ...
        <div className="flex items-center gap-1 mb-6 bg-card border border-border rounded-xl p-1 w-full sm:w-fit">
          {[
            ...
            <button
              key={t.id}
              onClick={() => setTab(t.id)}
              className={`cursor-pointer flex-1 sm:flex-none flex items-center justify-center sm:justify-start gap-1.5 sm:gap-2 px-2 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all ${
