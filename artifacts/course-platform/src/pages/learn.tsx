  ...
  return (
    <div className="min-h-screen bg-background flex flex-col" style={{ fontFamily: "var(--font-sans)" }}>
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {sidebarOpen && (
          <aside className="fixed md:relative top-13 bottom-0 left-0 md:inset-auto z-30 md:z-auto w-full sm:w-80 md:w-72 border-r border-border bg-card flex-shrink-0 flex flex-col overflow-hidden shadow-2xl md:shadow-none">
            {/* Sidebar header */}
