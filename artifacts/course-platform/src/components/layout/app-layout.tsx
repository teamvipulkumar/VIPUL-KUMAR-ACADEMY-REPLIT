...
export function Navbar() {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 w-full border-b transition-all duration-500 ${
        scrolled ? "shadow-[0_2px_20px_0_rgba(0,0,0,0.15)]" : ""
      }`} style={{
        backgroundColor: isTransparent ? "transparent" : "var(--nav-bg)",
        borderColor: isTransparent ? "transparent" : "var(--nav-border)",
      }}>
